...
const PROGRAM_DATA = {
  schedule: [
    ...
    { time: "11:50 am - 12:00noon", name: "Spotlight Paper Talk 2", authors: "Emaan Bilal Khan, Amy Winecoff, Miranda Bogen, Dylan Hadfield-Menell", title: "\"Side Effects May Include\": Alignment Decay from Counterfactual Self-Training" },
    { time: "12:00noon - 1:30pm", name: "Lunch Break" },
    { time: "1:30pm - 2:20pm", name: "Keynote 3", authors: "Jie Sun", title: "AI for virtual cells for pharma manufacturing" },
    { time: "2:20pm - 3:20pm", name: "Keynote 4", authors: "John Braun", title: "AI, the SIR Model, and DE-Constrained Kernel Smoothing for Pandemic Forecasting: Responsible AI/ML and UQ in Public Health" },
    { time: "3:20pm - 3:30pm", name: "Spotlight Paper Talk 3", authors: "Alexander Kai Le, Jay R Gopal, Hyeyeon Hwang, Ritambhara Singh", title: "SPACE: Sparsely Primed Autoencoder Counterfactual Explanations for Time-Series Clinical Data" },
